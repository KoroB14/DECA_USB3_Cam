...
const uint8_t CyFxUSBSSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    USB_CONSUMER_ENDPOINT,          /* Endpoint address and description */
    ...
    0x07,                           /* Descriptor size */
    CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
    USB_PRODUCER_ENDPOINT,          /* Endpoint address and description */
    CY_U3P_USB_EP_BULK,             /* Bulk endpoint type */
    0x00,0x04,                      /* Max packet size = 1024 bytes */
    0x00,                           /* Servicing interval for data transfers : 0 for Bulk */
...
const uint8_t CyFxUSBManufactureDscr[] __attribute__ ((aligned (32))) =
{
    42,                             /* Descriptor size */
    CY_U3P_USB_STRING_DESCR,        /* Device descriptor type */
    'O',0,'p',0,'e',0,'n',0,' ',0,'s',0,'o',0,'u',0,'r',0,'c',0,'e',0,
    ' ',0,'h',0,'a',0,'r',0,'d',0,'w',0,'a',0,'r',0,'e',0
};
...
const uint8_t CyFxUSBProductDscr[] __attribute__ ((aligned (32))) =
{
    36,                           	/* Descriptor size */
    CY_U3P_USB_STRING_DESCR,        /* Device descriptor type */
    'F',0,'P',0,'G',0,'A',0,' ',0,'V',0,'i',0,'d',0,
    'e',0,'o',0,' ',0,'S',0,'t',0,'r',0,'e',0,'a',0,'m',0
};
